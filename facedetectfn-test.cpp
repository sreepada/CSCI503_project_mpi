...
static void read_csv( string& filename, vector<Mat>& images, vector<int>& labels, char separator = ';') {
...
// Function main
int facedetect(const char* arg1,char *arg2)
{
    ...
    //    exit(1);
    //}
    string output_folder = arg2;
    //if (argc >= 3) {
    //	output_folder = argv[2];
    //}
    // Get the path to your CSV.
    string fn_csv = string(arg1);
